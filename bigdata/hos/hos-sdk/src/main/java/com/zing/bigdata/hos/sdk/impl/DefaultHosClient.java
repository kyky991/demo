package com.zing.bigdata.hos.sdk.impl;

import com.zing.bigdata.hos.common.*;
import com.zing.bigdata.hos.common.util.JsonUtil;
import com.zing.bigdata.hos.sdk.IHosClient;
import com.zing.bigdata.hos.sdk.MimeUtil;
import okhttp3.*;
...
public class DefaultHosClient implements IHosClient {

    private static Logger logger = Logger.getLogger(DefaultHosClient.class.getName());
    ...
    public DefaultHosClient(String endpoints, String key) {
        hosServer = endpoints;
    ...
    public void createBucket(String bucketName, String detail) throws IOException {
        Headers headers = buildHeaders(null, token, null);
    ...
    public void putObject(PutRequest putRequest) throws IOException {
        ...
        Headers headers = buildHeaders(putRequest.getAttrs(), token, putRequest.getContentEncoding());
    ...
    public ObjectListResult listObject(String bucket, String startKey, String endKey) throws IOException {
        ...
        Request request = new Request.Builder()
                ...
                .url(new HttpUrl.Builder()
                        ...
                        .host(host)
                        .port(port)
                        .addPathSegments("/hos/v1/object/list")
                        .addQueryParameter("bucket", bucket)
    ...
    public ObjectListResult listObject(ListObjectRequest request) throws IOException {
        return listObject(request.getBucket(), request.getStartKey(), request.getEndKey());
    }

    @Override
    public ObjectListResult listObjectByPrefix(String bucket, String dir, String prefix, String startKey) throws IOException {
        Headers headers = buildHeaders(null, token, null);
        Request request = new Request.Builder()
                .headers(headers)
                .url(new HttpUrl.Builder()
                        ...
                        .host(host)
                        .port(port)
                        .addPathSegments("/hos/v1/object/list/prefix")
                        .addQueryParameter("bucket", bucket)
    ...
    @Override
    public ObjectListResult listObjectByDir(String bucket, String dir, String startKey) throws IOException {
        ...
        Request request = new Request.Builder()
                ...
                .url(new HttpUrl.Builder()
                        ...
                        .host(host)
                        .port(port)
                        .addPathSegments("/hos/v1/object/list/dir")
                        .addQueryParameter("bucket", bucket)
                        .addQueryParameter("dir", dir)
                        .addQueryParameter("startKey", startKey)
                        .build())
    ...
    public HosObject getObject(String bucket, String key) throws IOException {
        ...
        if (response.isSuccessful()) {
            ...
            object.setMetaData(buildMetaData(response));
            return object;
        }
        response.close();
        return null;
    ...
    public BucketModel getBucketInfo(String bucketName) throws IOException {
        ...
        if (!response.isSuccessful()) {
            String message = response.body().string();
            response.close();
            throw new IOException("bucket not found " + message);
        }
        String json = response.body().string();
