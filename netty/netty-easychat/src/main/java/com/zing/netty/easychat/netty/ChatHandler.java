...
import com.zing.netty.easychat.SpringUtils;
import com.zing.netty.easychat.enums.MsgActionEnum;
import com.zing.netty.easychat.service.IUserService;
import com.zing.netty.easychat.utils.JsonUtils;
...
public class ChatHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, TextWebSocketFrame msg) throws Exception {
        ...
        if (action == MsgActionEnum.CONNECT.type) {
            ...
            System.out.println("聊天消息为[" + chatMessage.getMessage() + "]");
            ...
            System.out.println("需要签收的消息：" + msgIdList.toString());
